...
const DoctorDetail: React.FC<DetailProps> = ({ fields, entity, id }) => {
  entity = (entity === null && id !== null) ? useSelector((state: RootState)=> state.doctor.doctors.filter((doctor)=> doctor.id === id))[0]
  const renderEntity = () => {
