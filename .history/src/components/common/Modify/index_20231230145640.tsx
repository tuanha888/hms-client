...
const DateTimeInput = ({ field, form, ...props, showTime }) => {
  ...
  return (
    <div>
      <DatePicker
        ...
        showTimeSelect={showTime} // Conditionally add showTimeSelect
        timeIntervals={showTime ? 15 : null} // Conditionally add timeIntervals
      />
...
const Modify: React.FC<ModifyProps> = ({
  ...
  const renderDateTimeInput = ({ field, form }, showTime) => (
    <DateTimeInput
      field={field}
      form={form}
      showTime={showTime}
          ...
          renderFields.push(
            <div className="modal-data">
              ...
              <FieldForm
                name={field.fieldName}
                className="modal-input"
                render={(fieldProps) => renderDateTimeInput(fieldProps, true)}
              />
            </div>
          );
          ...
          renderFields.push(
            <div className="modal-data">
              ...
              <FieldForm
                name={field.fieldName}
                className="modal-input"
                render={(fieldProps) => renderDateTimeInput(fieldProps, false)}
              />
            </div>
          );
        }
