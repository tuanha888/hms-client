...
const Modify: React.FC<ModifyProps> = ({
  ...
  fields.forEach((field) => {
    if (isCreate) {
      // Initialize based on filetype for create operation
      switch (field.type) {
        case "text":
        case "textarea":
        ...
        case "datetime":
        case "dateday":
          initialValues[field.fieldName] = new Date().toISOString(); // You can set the default value for date
          break;
        default:
          initialValues[field.fieldName] = ""; // Set a default value for other filetypes
      }
    } else {
