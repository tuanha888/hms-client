...
export const Login = createAsyncThunk(
    ...
    async (data: LoginProps, {rejectWithValue}) => {
        ...
        if (response.data.role !== "DOCTOR") response.data.avatar = "https://res.cloudinary.com/ddiudyz6q/image/upload/v1681701487/fadebook/avatars/woman-avatar_ztjjly.png"
        else response.data.avatar = response.data.image;
