...
export const prescriptionSlice = createSlice({
    ...
    extraReducers(builder) {
        ...
        builder.addCase(createPrescription.fulfilled, (state, action) => {
            state.patientPrescriptions = [...state.patientPrescriptions, action.payload]
        })
        ...
        builder.addCase(deletePrescription.fulfilled, (state, action) => {
            state.patientPrescriptions = state.patientPrescriptions.filter(pres => pres !== action.payload)
        })
    },
})
